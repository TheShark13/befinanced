...
class Response
{
    ...
    {
        $this->headers = new ParamsBag($headers);
        $this->content = $content;
        $this->statusCode = $status;
        $this->statusText = isset(self::$statusTexts[$status]) ? self::$statusTexts[$status] : "Unknow status";
    ...
    /**
     * @param ParamsBag $headers
     * @return Response
     */
    public function setHeaders(ParamsBag $headers): Response
    {
    ...
    {
        return new Response($request->getContent(), http_response_code(), $request->getHeaders()->toArray());
    }
}